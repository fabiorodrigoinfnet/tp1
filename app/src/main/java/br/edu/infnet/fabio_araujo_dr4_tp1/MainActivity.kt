package br.edu.infnet.fabio_araujo_dr4_tp1
...
class MainActivity : AppCompatActivity() {
    ...
    //Metodo para achar a localização
    ...
    //Metodo para identificar a permissão
    ...
    //Metodo para verificar se o armazenamento externo está disponível pra ler e escrever
    fun isExternalStorageWritable(): Boolean {
        return Environment.getExternalStorageState() == Environment.MEDIA_MOUNTED
    }

    //Metodo para verificar se o armazenamento externo está disponível pra ao menos ler
